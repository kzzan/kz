...
func (pg *ProjectGenerator) GenerateProject() error {
	...
	files := map[string]string{
		...
		"internal/middleware/logger.go":     "templates/project/middleware_logger.go.tmpl",
		"internal/middleware/recovery.go":   "templates/project/middleware_recovery.go.tmpl",
		"internal/middleware/rate_limit.go": "templates/project/middleware_rate_limit.go.tmpl",
		"internal/middleware/auth.go":       "templates/project/middleware_auth.go.tmpl",
